...
main (int argc, char *argv[])
{
  ...
  // try to return the packet, note that the "from address" is 10.1.1.6 instead of the 192 address
  staticRoutingC->AddHostRouteTo (Ipv4Address ("10.1.1.1"), Ipv4Address ("10.1.1.5"), 1);
  ...
  ApplicationContainer clientApps = echoClient.Install (nA);
